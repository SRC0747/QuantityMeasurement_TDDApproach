...
class QuantityMeasurementTest {
    ...
    @Test
    public void given0DegCAnd0DegCFromDiffRef_ShouldReturnNotEqualTemperature() {
        QuantityMeasurement centigrade1 = new QuantityMeasurement(Temparature.CENTIGRADE, 0.0);
        QuantityMeasurement centigrade2 = new QuantityMeasurement(Temparature.CENTIGRADE, 0.0);
        Assertions.assertNotSame(centigrade1, centigrade2);
    }

    @Test
    public void given0DegFAnd0DegF_ShouldReturnEqualTemperature() {
        QuantityMeasurement fahrenheit1 = new QuantityMeasurement(Temparature.FAHRENHEIT, 0.0);
        QuantityMeasurement fahrenheit2 = new QuantityMeasurement(Temparature.FAHRENHEIT, 0.0);
        Assertions.assertEquals(fahrenheit1, fahrenheit2);
    }

    @Test
    public void given0DegFAnd1DegF_ShouldReturnNotEqualTemperature() {
        QuantityMeasurement fahrenheit1 = new QuantityMeasurement(Temparature.FAHRENHEIT, 0.0);
    ...
    @Test
    public void given0DegFAnd0DegFFromDiffRef_ShouldReturnNotEqualTemperature() {
        QuantityMeasurement fahrenheit1 = new QuantityMeasurement(Temparature.FAHRENHEIT, 0.0);
        QuantityMeasurement fahrenheit2 = new QuantityMeasurement(Temparature.FAHRENHEIT, 0.0);
        Assertions.assertNotSame(fahrenheit1, fahrenheit2);
    }
    ...
    @Test
    public void given0DegCAnd0DegF_WhenCompared_ShouldReturnEqualTemperature() {
        QuantityMeasurement centigrade = new QuantityMeasurement(Temparature.CENTIGRADE, 0.0);
        QuantityMeasurement fahrenheit = new QuantityMeasurement(Temparature.FAHRENHEIT, 0.0);
    ...
    @Test
    public void given100DegCAnd212DegF_WhenCompared_ShouldReturnEqualTemp() {
        QuantityMeasurement DEG_C = new QuantityMeasurement(Temparature.CENTIGRADE, 2.12);
        QuantityMeasurement DEG_F = new QuantityMeasurement(Temparature.FAHRENHEIT, 1.0);
        boolean compareCheck = DEG_C.compare(DEG_F);
        Assertions.assertTrue(compareCheck);
    }
}